...
class UserProfile(models.Model):
    user = models.OneToOneField(User, on_delete=models.CASCADE, verbose_name="Пользователь", validators=[validate_slug],)
...
class Order(models.Model):
    ...
    def __str__(self):
        return self.service.name or self.description or "Неименованный заказ"
